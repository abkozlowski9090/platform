...
class StarterSite extends TimberSite {
	...
	function add_to_context( $context ) {
		...
		$context['upcoming_events'] = Timber::get_posts($args);
		...
		$context['next_event'] = Timber::get_posts($args);
		...
		$context['latest_events'] = Timber::get_posts($args);
		...
		$context['featured_post'] = Timber::get_posts($args)[0];
